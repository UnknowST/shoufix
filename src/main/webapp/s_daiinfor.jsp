      ...
      <body>
        ...
        <div id="div2" align="center" style="height:130px;">
          ...
          <%-- <a
            ...
            <%-- <a style="font-weight:border;font-size:20px;"
              href="${pageContext.request.contextPath}/user/infor_eval?userid=${userid}&p=1">待确认</a>&nbsp;&nbsp;&nbsp;
              --%>
              <a style="font-weight:border;font-size:20px;"
        ...
        <%-- 待维修 --%>
          <div align="center" id="div1">
            ...
            <c:if test="${message.flag==1}">
              ...
              <a
                href="${pageContext.request.contextPath}/user/infor_dai?userid=${page.list[0].userid}&p=${page.firstPage}">第一页</a>
              <c:if test="${page.nextPage==0}">
                <a href="javascript:void(0)">下一页</a>
              </c:if>
              <c:if test="${page.nextPage!=0}">
                <a
                  href="${pageContext.request.contextPath}/user/infor_dai?userid=${page.list[0].userid}&p=${page.nextPage}">下一页</a>
              </c:if>
              ...
              <c:if test="${page.prePage!=0}">
                <a
                  href="${pageContext.request.contextPath}/user/infor_dai?userid=${page.list[0].userid}&p=${page.prePage}">上一页</a>
              </c:if>
              <a
                href="${pageContext.request.contextPath}/user/infor_dai?userid=${page.list[0].userid}&p=${page.lastPage}">最后页</a>
            </c:if>
          </div>
      </body>
