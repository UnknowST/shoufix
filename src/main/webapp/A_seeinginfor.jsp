<%-- Created by IntelliJ IDEA. User: 123 Date: 2020/10/26 Time: 10:00 To change this template use File | Settings | File
  Templates. --%>
        ...
        <body>
          ...
          <div id="div2" align="center" style="height:130px;">
            ...
            <%--查看正在维修的维修记录--%>
              ...
              <a class="bntup" href="${pageContext.request.contextPath}/admin/inginfor?p=1">正在维修</a>&nbsp;&nbsp;&nbsp;
              <a class="bntdown"
          ...
          <%--全部维修单--%>
            <div align="center" id="div1">
              ...
              <c:if test="${message.flag==1}">
                ...
                <a href="${pageContext.request.contextPath}/admin/inginfor?p=${page.firstPage}">第一页</a>
                <c:if test="${page.nextPage==0}">
                  <a href="javascript:void(0)">下一页</a>
                </c:if>
                <c:if test="${page.nextPage!=0}">
                  <a href="${pageContext.request.contextPath}/admin/inginfor?p=${page.nextPage}">下一页</a>
                </c:if>
                <c:if test="${page.prePage==0}">
                  <a href="javascript:void(0)">上一页</a>
                </c:if>
                <c:if test="${page.prePage!=0}">
                  <a href="${pageContext.request.contextPath}/admin/inginfor?p=${page.prePage}">上一页</a>
                </c:if>
                <a href="${pageContext.request.contextPath}/admin/inginfor?p=${page.lastPage}">最后页</a>
              </c:if>
            </div>
        </body>
