    ...
    <%@taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
      ...
      <head>
        ...
        <%--工人查看属于自己的待维修的维修单--%>
          ...
          <script>
            function okinfor(num) {
              $.ajax({
                url: '${pageContext.request.contextPath}/worker/ok_infor?num=' + num,
                type: 'post',
                dataType: 'json',
                async: false,
      ...
      <body>
        ...
        <div id="div2" align="center" style="height:130px;">
          ...
          <a style="font-weight:border;font-size:30px;background-color:#CCCCFF;border-radius:15px;text-decoration: none;"
            id="id2"
            href="${pageContext.request.contextPath}/worker/allinfor?workerid=${workerid}&p=1">待维修</a>&nbsp;&nbsp;&nbsp;
          <a
            href="${pageContext.request.contextPath}/worker/infor_ing?workerid=${workerid}&p=1">正在维修</a>&nbsp;&nbsp;&nbsp;
          <a
            href="${pageContext.request.contextPath}/worker/infor_ok?workerid=${workerid}&p=1">已维修</a>&nbsp;&nbsp;&nbsp;
        </div>
        <%--全部维修单--%>
          ...
          <div align="center" id="div1">
            ...
            <c:if test="${message.flag==1}">
                      ...
                      <%if(count%2==0){%>
                        <tr style="background-color:aliceblue">
                          ...
                          <td><a href="javascript:void(0)"
                              onclick="okinfor('${infor.num}')">确认维修单</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                          </td>
                        </tr>
                        <%}%>
                          <%if(count%2==1){%>
              ...
              <a
                href="${pageContext.request.contextPath}/worker/allinfor?workerid=${workerid}&p=${page.firstPage}">第一页</a>
              <c:if test="${page.nextPage==0}">
                <a href="javascript:void(0)">下一页</a>
              </c:if>
              <c:if test="${page.nextPage!=0}">
                <a
                  href="${pageContext.request.contextPath}/worker/allinfor?userid=${page.list[0].userid}&p=${page.nextPage}">下一页</a>
              </c:if>
              ...
              <c:if test="${page.prePage!=0}">
                <a
                  href="${pageContext.request.contextPath}/worker/allinfor?userid=${page.list[0].userid}&p=${page.prePage}">上一页</a>
              </c:if>
              <a
                href="${pageContext.request.contextPath}/worker/allinfor?workerid=${workerid}&p=${page.lastPage}">最后页</a>
            </c:if>
          </div>
      </body>
